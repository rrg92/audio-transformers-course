...
** Rodrigo Ribeiro Gomes, Head de Inovação na Power Tuning **
Tradução principal.

** Isabella Bicalho Frazeto, Engenheira de Machien Learning ** 
Tradução Auxiliar e Revisão.
...
* [Unidade 7](https://huggingface.co/learn/audio-course/chapter7): aprenda como construir aplicações com transformers para o mundo real
